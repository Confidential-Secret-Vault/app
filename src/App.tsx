...
import "./App.css";
import EncryptedPayrollUI from "./components/secretvault";
...
function App() {
  ...
  const [fhevmStatus, setFhevmStatus] = useState<
  ...
  const initializeFhevm = async () => {
    ...
    console.log("🔄 Initializing FHEVM for React...");
    try {
    ...
    try {
      ...
      if (error.code === 4902) {
        try {
          ...
          setNetworkError(
            "Failed to add Sepolia network. Please add it manually in your wallet."
          );
  ...
  const connectWallet = async () => {
    ...
    if (!window.ethereum) {
      console.error(
        "❌ No Ethereum provider found. Please install MetaMask or connect a wallet."
      );
            ...
            <div className="flex items-center gap-3">
              {fhevmStatus === "ready" ? (
                <div className="flex items-center gap-2">
                  ...
                  <span className="status-badge bg-green-600 text-white">
                    READY
                  </span>
                </div>
              ) : fhevmStatus === "error" ? (
                ...
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 bg-black rounded-full flex items-center justify-center">
                    <svg
                      className="w-4 h-4 text-[#FFEB3B] animate-spin"
                      fill="none"
                      viewBox="0 0 24 24"
                    >
                      <circle
                  ...
                  <span className="status-badge bg-black text-[#FFEB3B]">
                    LOADING
                  </span>
                </div>
              ) : (
                <div className="flex items-center gap-2">
                  ...
                  <span className="status-badge bg-gray-500 text-white">
                    IDLE
                  </span>
                </div>
              )}
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
            ...
            {!isConnected ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-400 mb-4">
                  Connect your wallet to use FHEVM features
                </p>
                ...
                <div className="mt-4 p-3 bg-[#0A0A0A] border border-[#FFEB3B]/30 rounded-lg">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-[#FFEB3B] font-semibold text-xs">
                      Network Notice
                    </span>
                  </div>
                  <p className="text-gray-400 text-xs leading-relaxed">
                    <strong className="text-[#FFEB3B]">Important:</strong> This
                    app requires the Sepolia testnet. After connecting your
                    wallet, you'll be prompted to switch to Sepolia if you're on
                    a different network.
                  </p>
                </div>
                ...
                <div className="mt-4 p-3 bg-[#0A0A0A] border border-[#FFEB3B]/30 rounded-lg">
                  <p className="text-gray-400 text-xs leading-relaxed">
                    <strong className="text-[#FFEB3B]">Note:</strong> This is a
                    demonstration using REAL FHEVM SDK from Zama's CDN. The SDK
                    provides actual encryption/decryption functionality on
                    Sepolia testnet.
                  </p>
                </div>
              </div>
                ...
                <div className="info-card">
                  <div className="flex flex-col gap-2">
                    ...
                    {contractAddress === "Not supported chain" ? (
                      ...
                      <span className="code-text text-[#FFEB3B]">
                        {contractAddress}
                      </span>
                    )}
                  </div>
        ...
        {isConnected && fhevmStatus === "ready" && (
          <div className="w-full gap-8">
            <EncryptedPayrollUI account={account} isConnected={isConnected} />
          </div>
        )}
      </main>
    </div>
